...
/*
Operator which will compare the size of the carpets to determine if the
current object is greater than or equal to right.
*/
bool FeetInches::operator >=(const FeetInches &right) {
    bool status;
    int total;
...
/*
Operator which will compare the size of the carpets to determine if the
current object is not equal to right.
*/
bool FeetInches::operator !=(const FeetInches &right) {
    bool status;
...
/*
Operator which will compare the size of the carpets to determine if the
current object is less than or equal to right.
*/
bool FeetInches::operator <=(const FeetInches &right) {
    bool status;
    int total;
